...
import ScheduledPaymentsListPreview from './ScheduledPaymentsListPreview';
import ScheduledPaymentsListSourceCode from './ScheduledPaymentsListSourceCode';
...
function ScheduledPaymentsListItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <ScheduledPaymentsListPreview />
                        </ResizablePreview>
                    </TabPanel>
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <ScheduledPaymentsListSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="scheduled-payments-list"
                    blocks={listBlocks}
...
export default ScheduledPaymentsListItemsPreview