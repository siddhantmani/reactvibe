...
import ProgressOverviewListPreview from './ProgressOverviewListPreview';
import ProgressOverviewListPreviewSourceCode from './ProgressOverviewListPreviewSourceCode';
...
function ProgressOverviewListItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <ProgressOverviewListPreview />
                        </ResizablePreview>
                    </TabPanel>
                    
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <ProgressOverviewListPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="progress-overview-list"
                    blocks={listBlocks}
...
export default ProgressOverviewListItemsPreview
