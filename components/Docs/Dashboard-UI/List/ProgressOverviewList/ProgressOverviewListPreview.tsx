...
function ProgressOverviewListPreview() {
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="rounded-[15px] border border-black/10 bg-white p-3 px-3 shadow-[0_15px_40px_rgba(0,0,0,0.03)] dark:border-white/10 dark:bg-[#0c0c0c] dark:shadow-none max-w-5xl mx-auto mt-20"
        >
            {/* Header */}
