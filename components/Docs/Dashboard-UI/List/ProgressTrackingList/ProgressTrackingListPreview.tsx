                ...
                <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4 flex-wrap">
                            ...
                            <h3 className={`${manrope.className} font-[600] text-[11px] text-[#111827] dark:text-white`}>
                                {title}
                            </h3>
                            ...
                            <LinearReveal
                                ...
                                className={`${manrope.className} font-[600] text-[12px] text-[#4b5563] dark:text-gray-400`}
                            />
                        ...
                        <LinearReveal
                            ...
                            delay={0.4}
                            Text={`${progress}%`}
                            className={`${manrope.className} font-[600] text-[13px] text-[#111827] dark:text-white`}
                        />
...
function ProgressTrackingListPreview() {
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="w-full rounded-[15px] border border-black/10 dark:border-white/10 bg-white dark:bg-[#0c0c0c] p-3 px-3 shadow-[0_15px_40px_rgba(0,0,0,0.03)] dark:shadow-none max-w-xl mx-auto">

            {/* Header */}
            <div className="flex items-center justify-between mb-10">

                <h1 className={`${manrope.className} font-[600] text-[12px] text-[#111827] dark:text-white`}>
                    Progress Tracking List
                </h1>

                <button className={`${manrope.className} font-[600] text-[12px] text-[#006b46] dark:text-green-400 hover:opacity-80 transition-opacity`}>
                    View All
                </button>
            </div>
