...
import ProgressTrackingListPreview from './ProgressTrackingListPreview';
import ProgressTrackingListPreviewSourceCode from './ProgressTrackingListPreviewSourceCode';
...
function ProgressTrackingListItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <ProgressTrackingListPreview />
                        </ResizablePreview>
                    </TabPanel>
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <ProgressTrackingListPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="progress-tracking-list"
                    blocks={listBlocks}
...
export default ProgressTrackingListItemsPreview