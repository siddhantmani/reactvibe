...
import AlertNotificationListPreview from './AlertNotificationListPreview';
import AlertNotificationListPreviewSourceCode from './AlertNotificationListPreviewSourceCode';
...
import { listBlocks } from '@/lib/dashboardUi/list';
import RefrashContent from '@/components/Docs/RefrashContent';
import { useState } from 'react';

function AlertNotificationListItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    <TabPanel
                        ...
                        className="border border-gray-700 rounded-2xl relative h-[600px] bg-white dark:bg-[#0b0b0b]"
                    >
                        ...
                        >
                            <AlertNotificationListPreview />
                        </ResizablePreview>
                    </TabPanel>

                    <TabPanel static hidden={selectedIndex !== 1}>
                        <AlertNotificationListPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="alert-notification-list"
                    blocks={listBlocks}
                    basePath="/docs/dashboard-ui/list"
                    title="Explore more List blocks"
                />
            </div>
        </div>
    )
...
export default AlertNotificationListItemsPreview