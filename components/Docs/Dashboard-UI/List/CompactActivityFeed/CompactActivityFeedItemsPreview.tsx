...
import CompactActivityFeedPreview from './CompactActivityFeedPreview';
import CompactActivityFeedPreviewSourceCode from './CompactActivityFeedPreviewSourceCode';
...
function CompactActivityFeedItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <CompactActivityFeedPreview />
                        </ResizablePreview>
                    </TabPanel>
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <CompactActivityFeedPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="compact-activity-feed"
                    blocks={listBlocks}
...
export default CompactActivityFeedItemsPreview