...
function ActivityTimelineListPreview() {
    ...
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="rounded-[15px] max-w-xl mx-auto  border border-black/10 dark:border-white/10 bg-white dark:bg-[#0c0c0c] p-3 px-3">
...
export default ActivityTimelineListPreview