...
import ActivityTimelineListPreview from './ActivityTimelineListPreview';
import ActivityTimelineListPreviewSourceCode from './ActivityTimelineListPreviewSourceCode';
...
function ActivityTimelineListItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <ActivityTimelineListPreview />
                        </ResizablePreview>
                    </TabPanel>

                    <TabPanel static hidden={selectedIndex !== 1}>
                        <ActivityTimelineListPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="activity-timeline-list"
                    blocks={listBlocks}
...
export default ActivityTimelineListItemsPreview