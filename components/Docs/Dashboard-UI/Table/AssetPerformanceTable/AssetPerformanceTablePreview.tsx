...
function AssetPerformanceTablePreview() {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10">
                ...
                {/* Table */}
                {/* FIX 1: Changed `overflow-hidden` to `overflow-x-auto` to allow horizontal scrolling */}
...
export default AssetPerformanceTablePreview