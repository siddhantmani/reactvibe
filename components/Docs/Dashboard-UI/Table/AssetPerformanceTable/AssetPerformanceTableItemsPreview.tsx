...
import AssetPerformanceTablePreview from './AssetPerformanceTablePreview';
import DashboardFrame from '@/components/DashboardFrame';
import AssetPerformanceTableItemsPreviewSourceCode from './AssetPerformanceTableItemsPreviewSourceCode';
...
function AssetPerformanceTableItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <AssetPerformanceTablePreview />
                        </ResizablePreview>
                    </TabPanel>
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <AssetPerformanceTableItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="asset-performance-table"
                    blocks={tableBlocks}
...
export default AssetPerformanceTableItemsPreview