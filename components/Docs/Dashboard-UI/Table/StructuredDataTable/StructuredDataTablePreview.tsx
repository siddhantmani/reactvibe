...
function StructuredDataTablePreview() {
    return (
        <motion.div
            ...
            className="rounded-[15px] border border-black/10 bg-white dark:border-white/10 dark:bg-[#0c0c0c] p-3 px-3 gap-10 w-full overflow-x-auto"
        >
            <div>
...
export default StructuredDataTablePreview