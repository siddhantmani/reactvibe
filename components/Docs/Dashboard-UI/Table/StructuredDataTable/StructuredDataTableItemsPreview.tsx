...
import StructuredDataTablePreview from './StructuredDataTablePreview';
import DashboardFrame from '@/components/DashboardFrame';
import StructuredDataTableItemsPreviewSourceCode from './StructuredDataTableItemsPreviewSourceCode';
...
function StructuredDataTableItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <StructuredDataTablePreview />
                        </ResizablePreview>
                    </TabPanel>
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <StructuredDataTableItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="structured-data-table"
                    blocks={tableBlocks}
...
export default StructuredDataTableItemsPreview