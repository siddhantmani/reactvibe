...
function EntityManagementTableOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "page.tsx", path: "/Dashboard-UI/Table/EntityManagementTable/page.tsx" },
...
export default EntityManagementTableOpenCode;