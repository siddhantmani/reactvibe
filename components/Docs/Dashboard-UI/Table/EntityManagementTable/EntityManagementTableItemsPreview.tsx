...
import EntityManagementTablePreview from './EntityManagementTablePreview';
import EntityManagementTablePreviewSourceCode from './EntityManagementTablePreviewSourceCode';
...
function EntityManagementTableItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    <TabPanel
                        ...
                        className="border border-gray-700 rounded-2xl relative h-[850px] bg-white dark:bg-[#0b0b0b]"
                    >
                        ...
                        >
                            <EntityManagementTablePreview />
                        </ResizablePreview>
                    </TabPanel>
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <EntityManagementTablePreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="entity-management-table"
                    blocks={tableBlocks}
...
export default EntityManagementTableItemsPreview