...
import TransactionTablePreview from './TransactionTablePreview';
import TransactionTablePreviewSourceCode from './TransactionTablePreviewSourceCode';
...
function TransactionTableItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    <TabPanel
                        ...
                        className="border border-gray-700 rounded-2xl relative h-[770px] bg-white dark:bg-[#0b0b0b]"
                    >
                    ...
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <TransactionTablePreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
...
export default TransactionTableItemsPreview