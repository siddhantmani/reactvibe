...
import AdvancedTransactionLogPreview from './AdvancedTransactionLogPreview';
import DashboardFrame from '@/components/DashboardFrame';
import AdvancedTransactionLogItemsPreviewSourceCode from './AdvancedTransactionLogItemsPreviewSourceCode';
...
import { tableBlocks } from '@/lib/dashboardUi/table';
import { useState } from 'react';
import RefrashContent from '@/components/Docs/RefrashContent';


function AdvancedTransactionLogItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    <TabPanel
                        ...
                        className="border border-gray-700 rounded-2xl relative h-[750px] bg-white dark:bg-[#0b0b0b]"
                    >
                        ...
                        >
                            <AdvancedTransactionLogPreview />
                        </ResizablePreview>
                    </TabPanel>
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <AdvancedTransactionLogItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="advanced-transaction-log"
                    blocks={tableBlocks}
                    basePath="/docs/dashboard-ui/table"
                    title="Explore more Table blocks"
                />
            </div>
        </div>
    )
...
export default AdvancedTransactionLogItemsPreview