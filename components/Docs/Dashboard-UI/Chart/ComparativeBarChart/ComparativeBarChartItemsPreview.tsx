...
import ComparativeBarChartPreview from './ComparativeBarChartPreview';
import ComparativeBarChartPreviewSourceCode from './ComparativeBarChartPreviewSourceCode';
...
function ComparativeBarChartItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <ComparativeBarChartPreview />
                        </ResizablePreview>
                    </TabPanel>

                    <TabPanel static hidden={selectedIndex !== 1}>
                        <ComparativeBarChartPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="comparative-bar-chart"
                    blocks={chartBlocks}
...
export default ComparativeBarChartItemsPreview