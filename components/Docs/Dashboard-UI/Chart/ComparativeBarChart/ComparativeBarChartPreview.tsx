...
function ComparativeBarChartPreview() {
    ...
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="w-[calc(100%-32px)] @sm:w-full rounded-[15px] border border-black/10 bg-white p-3 px-3 @sm:p-5 shadow-[0_15px_40px_rgba(0,0,0,0.03)] dark:border-white/10 dark:bg-[#0c0c0c] dark:shadow-none max-w-xl mx-auto mt-20 @xl:scale-[110%]"
        >
            ...
            <div className="flex items-start justify-between gap-2 @sm:gap-5">
                ...
                <div className="flex flex-col">
                    ...
                    <LinearReveal
                        ...
                        className={`${boldFont.className} text-[20px] mt-1 ${netValue >= 0 ? "text-green-500" : "text-red-500"
                            }`}
                    />
                </div>
                ...
                <div className="flex flex-col items-end justify-between self-stretch">
                    ...
                    {/* Dropdown */}
                    <button className={`${boldFont.className} px-2 py-1 rounded-[4px] border border-black/10 dark:border-white/10 flex items-center gap-2 @sm:gap-3 text-[10px] text-[#111827] dark:text-white bg-white dark:bg-[#15181d]`}>
                        This Month
                        <ChevronDown
                            size={12}
                            strokeWidth={2.4}
                    ...
                    <div className="flex items-center gap-2 @sm:gap-4 mt-4">
                        <div className="flex items-center gap-1.5 @sm:gap-3">
                            ...
                            <p className={`${boldFont.className} text-[10px] @sm:text-[11px] text-[#111827] dark:text-white`}>
                                Income
                            </p>
                        </div>
            ...
            <div className="relative mt-6 @sm:mt-4">
                ...
                <div className="relative h-[190px]">
                    ...
                    {/* Bars */}
                    <div className="absolute left-[35px] @sm:left-[60px] right-0 top-0 bottom-0 flex items-end justify-between px-1">
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <AnimatePresence>
                                        {isActive && (
                                            <motion.div
                                                ...
                                                className="absolute bottom-[105%] left-1/2 -translate-x-1/2 z-30 w-max rounded-[10px] border border-black/10 dark:border-white/10 bg-white dark:bg-[#0c0c0c] p-2 px-3 shadow-[0_15px_40px_rgba(0,0,0,0.08)] dark:shadow-none"
                                            >
                                    ...
                                    <motion.div
                                        ...
                                        className="relative h-[140px] w-[10px] @sm:w-[15px] flex flex-col items-center justify-center"
                                    >
                                        {/* Income */}
                                        <div
                                            className="w-full rounded-t-full bg-gradient-to-b from-[#006b46] to-[#008556] transition-all duration-300"
                                            style={{
                                        ...
                                        {/* Expense */}
                                        <div
                                            className="w-full rounded-b-full bg-gradient-to-b from-[#86db68] to-[#6fd14c] transition-all duration-300"
                                            style={{
                                    ...
                                    {/* Month */}
                                    <p className={`${boldFont.className} text-[8px] @sm:text-[9px] text-[#4b5563] dark:text-gray-500 mt-3 @sm:mt-5`}>
                                        {item.month}
                                    </p>
                                </div>
                            )
