...
function PerformanceTrendChartOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "page.tsx", path: "/Dashboard-UI/Chart/PerformanceTrendChart/page.tsx" },
...
export default PerformanceTrendChartOpenCode;