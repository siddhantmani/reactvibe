...
import PerformanceTrendChartPreview from './PerformanceTrendChartPreview';
import PerformanceTrendChartPreviewSourceCode from './PerformanceTrendChartPreviewSourceCode';
...
function PerformanceTrendChartItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <PerformanceTrendChartPreview />
                        </ResizablePreview>
                    </TabPanel>
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <PerformanceTrendChartPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="performance-trend-chart"
                    blocks={chartBlocks}
...
export default PerformanceTrendChartItemsPreview