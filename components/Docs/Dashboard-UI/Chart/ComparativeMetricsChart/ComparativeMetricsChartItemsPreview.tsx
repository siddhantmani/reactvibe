...
import ComparativeMetricsChartPreview from './ComparativeMetricsChartPreview';
import ComparativeMetricsChartItemsPreviewSourceCode from './ComparativeMetricsChartItemsPreviewSourceCode';
...
function ComparativeMetricsChartItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <ComparativeMetricsChartPreview />
                        </ResizablePreview>
                    </TabPanel>

                    <TabPanel static hidden={selectedIndex !== 1}>
                        <ComparativeMetricsChartItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="comparative-metrics-chart"
                    blocks={chartBlocks}
                    basePath="/docs/dashboard-ui/chart"
                    title="Explore more Chart blocks"
                />
            </div>
        </div>
    )
...
export default ComparativeMetricsChartItemsPreview