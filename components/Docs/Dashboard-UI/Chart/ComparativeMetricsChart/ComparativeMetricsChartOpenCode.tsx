...
function ComparativeMetricsChartOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "page.tsx", path: "/Dashboard-UI/Chart/ComparativeMetricsChart/page.tsx" },
...
export default ComparativeMetricsChartOpenCode;