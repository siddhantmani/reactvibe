...
import DistributionBreakdownChartPreview from './DistributionBreakdownChartPreview';
import DistributionBreakdownChartPreviewSourceCode from './DistributionBreakdownChartPreviewSourceCode';
...
function DistributionBreakdownChartItemsPreview() {
    ...
    return (
        <div className='relative'>
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <DistributionBreakdownChartPreview />
                        </ResizablePreview>
                    </TabPanel>

                    <TabPanel static hidden={selectedIndex !== 1}>
                        <DistributionBreakdownChartPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="distribution-breakdown-chart"
                    blocks={chartBlocks}
...
export default DistributionBreakdownChartItemsPreview