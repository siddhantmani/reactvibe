...
function DistributionBreakdownChartOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "page.tsx", path: "/Dashboard-UI/Chart/DistributionBreakdownChart/page.tsx" },
...
export default DistributionBreakdownChartOpenCode;