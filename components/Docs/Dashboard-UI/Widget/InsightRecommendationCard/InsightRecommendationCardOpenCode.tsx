...
function InsightRecommendationCardOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "page.tsx", path: "/Dashboard-UI/Widget/InsightRecommendationCard/page.tsx" },
...
export default InsightRecommendationCardOpenCode;