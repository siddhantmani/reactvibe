...
import ConnectionFlowPreview from './ConnectionFlowPreview';
import ConnectionFlowPreviewSourceCode from './ConnectionFlowPreviewSourceCode';


function ConnectionFlowItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <ConnectionFlowPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
        </div>
...
export default ConnectionFlowItemsPreview