...
function ConnectionFlowOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Motion/ConnectionFlow/Page.tsx" },
        ],
    };
    ...
    return (
        <div>
            <LinearReveal
                as={"h2"}
                className={`${LinearRevealFont.className} font-[700] text-4xl mb-4`}
                Text='Step 1'
            />
...
export default ConnectionFlowOpenCode;