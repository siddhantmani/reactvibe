...
function BranchFlowItemsOpenCode() {
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Motion/BranchFlow/Page.tsx" },
            { name: "BranchFlow.tsx", path: "/Motion/BranchFlow/BranchFlow.tsx" },
        ],
    };
...
export default BranchFlowItemsOpenCode