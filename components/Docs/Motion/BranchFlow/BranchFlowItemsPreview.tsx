...
import BranchFlowPreview from './BranchFlowPreview';
import BranchFlowItemsPreviewSourceCode from './BranchFlowItemsPreviewSourceCode';

function BranchFlowItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <BranchFlowItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
        </div>
...
export default BranchFlowItemsPreview