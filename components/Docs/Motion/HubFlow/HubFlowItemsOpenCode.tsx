...
function HubFlowItemsOpenCode() {
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Motion/HubFlow/Page.tsx" },
            { name: "HubFlow.tsx", path: "/Motion/HubFlow/HubFlow.tsx" },
        ],
    };
...
export default HubFlowItemsOpenCode