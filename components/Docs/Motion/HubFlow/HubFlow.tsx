...
import reactvibeimg from "@/images/logo/logo.png"
...
export default function HubFlow({
    ...
    bottomParticleColor = "#3b82f6", // Distinct color for bottom particles
    particleSpeed = 2.5,
    particleLength = 16,
    particleWeight = 3,
    particleCurve = 1.5,
    ...
    return (
        <div className="bg-gray-50 dark:bg-[#050505] flex items-center justify-center p-4 font-sans overflow-hidden transition-colors duration-300">
            ...
            <div className="w-full overflow-x-auto custom-scrollbar flex justify-start md:justify-center">
                ...
                <div className="w-[1000px] h-[800px] relative shrink-0">
                    ...
                    <div
                        className="absolute z-30 flex items-center justify-center pl-3 pr-4 bg-white dark:bg-[#E5E2D9] shadow-lg dark:shadow-[0_0_40px_rgba(249,115,22,0.15)] transition-colors duration-300 gap-2"
                        style={{
