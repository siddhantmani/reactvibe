...
import NodeFlowPreview from './NodeFlowPreview';
import NodeFlowPreviewSourceCode from './NodeFlowPreviewSourceCode';

function NodeFlowItemsPreview() {
...
export default NodeFlowItemsPreview