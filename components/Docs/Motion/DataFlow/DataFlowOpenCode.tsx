...
function DataFlowOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Motion/DataFlow/Page.tsx" },
            { name: "DataFlow.tsx", path: "/Motion/DataFlow/DataFlow.tsx" },
        ],
    };
...
export default DataFlowOpenCode;