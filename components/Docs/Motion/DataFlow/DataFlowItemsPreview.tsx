...
import DataFlowPreview from './DataFlowPreview';
import DataFlowPreviewSourceCode from './DataFlowPreviewSourceCode';

function DataFlowItemsPreview() {
...
export default DataFlowItemsPreview