...
import ConvergePreview from './ConvergePreview';
import ConvergeItemsPreviewSourceCode from './ConvergeItemsPreviewSourceCode';

function ConvergeItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    <TabPanel
                        ...
                        className="border border-gray-700 rounded-2xl relative h-[670px] bg-white dark:bg-[#0b0b0b]"
                    >
                    ...
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <ConvergeItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
        </div>
...
export default ConvergeItemsPreview