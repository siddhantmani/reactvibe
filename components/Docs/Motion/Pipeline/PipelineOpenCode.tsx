...
function PipelineOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Motion/Pipeline/Page.tsx" },
            { name: "Pipeline.tsx", path: "/Motion/Pipeline/Pipeline.tsx" },
        ],
    };
...
export default PipelineOpenCode;