...
function PulsePingCode() {
    // 👇 Folder & File Tree
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Components/PulsePing/Page.tsx" },
            { name: "PulsePing.tsx", path: "/Components/PulsePing/PulsePing.tsx" },
        ],
    };
