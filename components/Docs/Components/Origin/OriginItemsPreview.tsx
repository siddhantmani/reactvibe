...
import OriginPreview from './OriginPreview';
import OriginItemsPreviewSourceCode from './OriginItemsPreviewSourceCode';


function OriginItemsPreview() {
...
export default OriginItemsPreview