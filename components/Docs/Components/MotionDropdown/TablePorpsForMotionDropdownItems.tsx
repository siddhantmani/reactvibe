...
function TablePorpsForMotionDropdownItems() {
    return (
                ...
                <TableBody>
                    ...
                    <TableRow>
                        ...
                        <TableCell className={PropertyPoint.className}>
                            Additional classes applied to the dropdown menu and all nested submenus.
                        </TableCell>
                    </TableRow>

                    <TableRow>
                        <TableCell className={PropertyPoint.className}>itemClassName</TableCell>
                        <TableCell className={PropertyPoint.className}>"text-black"</TableCell>
                        <TableCell className={PropertyPoint.className}>
                            Additional classes applied to all dropdown items, including nested items and headings.
                        </TableCell>
                    </TableRow>
                </TableBody>
            </Table>
...
export default TablePorpsForMotionDropdownItems