...
import MotionDropdownPreview from './MotionDropdownPreview';
import MotionDropdownPreviewSourceCode from './MotionDropdownPreviewSourceCode';
...
function MotionDropdownItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <MotionDropdownPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
        </div>
...
export default MotionDropdownItemsPreview