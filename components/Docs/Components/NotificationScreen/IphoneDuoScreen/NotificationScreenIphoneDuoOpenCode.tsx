...
function NotificationScreenIphoneDuoOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "NotificationScreenIphoneDuo.tsx", path: "/Components/NotificationScreen/NotificationScreenIphoneDuo.tsx" },
            { name: "Flowlist.tsx", path: "/Components/Flowlist/Flowlist.tsx" },
        ],
    };
...
export default NotificationScreenIphoneDuoOpenCode