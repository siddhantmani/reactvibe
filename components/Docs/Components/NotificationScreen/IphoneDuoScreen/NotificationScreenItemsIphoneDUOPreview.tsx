...
import NotificationScreenIphoneDUOPreview from './NotificationScreenIphoneDUOPreview';
import NotificationScreenIphoneDUOPreviewSourceCode from './NotificationScreenIphoneDUOPreviewSourceCode';

function NotificationScreenItemsIphoneDUOPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    <TabPanel
                        ...
                        className="border border-gray-700 rounded-2xl relative h-[820px] bg-white dark:bg-[#0b0b0b]"
                    >
                        ...
                        >
                            <NotificationScreenIphoneDUOPreview />
                        </ResizablePreview>
                    </TabPanel>
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <NotificationScreenIphoneDUOPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
        </div>
...
export default NotificationScreenItemsIphoneDUOPreview