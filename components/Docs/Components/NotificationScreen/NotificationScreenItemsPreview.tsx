...
import NotificationScreenPreview from './NotificationScreenPreview';
import NotificationScreenPreviewSourceCode from './NotificationScreenPreviewSourceCode';

function NotificationScreenItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <NotificationScreenPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
        </div>
...
export default NotificationScreenItemsPreview