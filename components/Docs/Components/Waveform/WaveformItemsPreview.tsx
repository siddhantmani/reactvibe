...
import { Code, Eye } from 'lucide-react'; import RefrashContent from '../../RefrashContent';
import WaveformPreview from './WaveformPreview';
import WaveformPreviewSourceCode from './WaveformPreviewSourceCode';
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    <TabPanel
                        ...
                        className="border border-gray-700 rounded-2xl relative h-[400px] bg-white dark:bg-[#0b0b0b]"
                    >
...
export default WaveformItemsPreview