    ...
    return (
        ...
        >
            {/* <div className='flex justify-between w-full relative z-0'>
                <div className='bg-white h-96 w-96 rounded-sm blur-[220px] absolute z-0' />
                <div className='bg-[#b6a6b4] h-52 w-36 rounded-full blur-[100px] absolute right-0 z-0' />
            </div> */}
            {/* Top Row */}
            ...
            {/* <div className='flex justify-between w-full relative -top-[20px] -right-100'>
                <div className='bg-[#B8A9DD] h-64 w-64 rounded-xl blur-[140px]  absolute -bottom-[170px]' />
                <div className='bg-[#ba2ba7] h-52 w-36 rounded-full blur-[100px]   absolute right-0' />
            </div> */}
        </motion.div>
    );
}
