...
import { builtWithMotionSwitch } from "@/lib/builtWithMotionSwitch";

function BuiltWithMotionSwitch() {
    return (
        <div className="space-y-8 max-w-7xl mx-auto px-2">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                {builtWithMotionSwitch.map((block, index) => {
...
export default BuiltWithMotionSwitch