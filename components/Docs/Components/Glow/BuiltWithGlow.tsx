...
import { builtWithGlow } from "@/lib/builtWithGlow";

function BuiltWithGlow() {
    return (
        <div className="space-y-8 max-w-7xl mx-auto px-2">
            ...
            >
                ...
                <p className={`${manrope.className} font-[400] text-muted-foreground`}>
                    See how Glow is used across React Vibe blocks, templates, and components. Explore real examples to get ideas for your own projects.
                </p>
            </motion.div>

            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                {builtWithGlow.map((block, index) => {
