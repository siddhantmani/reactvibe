...
import { builtWithSpotlight } from "@/lib/builtWithSpotlight";
import { builtWithOrbitBorder } from "@/lib/builtWithOrbitBorder";

function BuiltWithOrbitBorder() {
    return (
        <div className="space-y-8 max-w-7xl mx-auto px-2">
            ...
            >
                ...
                >
                    Built with Orbit Border
                </h1>

                <p className={`${manrope.className} font-[400] text-muted-foreground`}>
                    See how Orbit Border is used across React Vibe blocks, templates, and components. Explore real examples to get ideas for your own projects.
                </p>
            </motion.div>

            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                {builtWithOrbitBorder.map((block, index) => {
...
export default BuiltWithOrbitBorder