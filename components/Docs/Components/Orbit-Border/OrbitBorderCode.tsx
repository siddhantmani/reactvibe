...
function OrbitBorderCode() {
    // 👇 Folder & File Tree
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Components/TheOrbitBorderCode/Page.tsx" },
            { name: "OrbitBorder.tsx", path: "/Components/TheOrbitBorderCode/OrbitBorder.tsx" },
        ],
    };
...
export default OrbitBorderCode;
