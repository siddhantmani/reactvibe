...
function ShadowButtonCode() {
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Components/Shadow-Button/Page.tsx" },
            { name: "ShadowButton.tsx", path: "/Components/Shadow-Button/ShadowButton.tsx" },
        ],
    };
...
export default ShadowButtonCode;
