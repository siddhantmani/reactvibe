...
function AnimatedGradientBadgeOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Components/AnimatedGradientBadge/Page.tsx" },
            { name: "AnimatedGradientBadge.tsx", path: "/Components/AnimatedGradientBadge/AnimatedGradientBadge.tsx" },
        ],
    };
...
export default AnimatedGradientBadgeOpenCode;