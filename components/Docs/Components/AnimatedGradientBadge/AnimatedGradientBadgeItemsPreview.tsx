...
import AnimatedGradientBadgePreview from './AnimatedGradientBadgePreview';
import AnimatedGradientBadgePreviewSourceCode from './AnimatedGradientBadgePreviewSourceCode';

function AnimatedGradientBadgeItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <AnimatedGradientBadgePreview />
                        </ResizablePreview>
                    </TabPanel>

                    <TabPanel static hidden={selectedIndex !== 1}>
                        <AnimatedGradientBadgePreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
        </div>
...
export default AnimatedGradientBadgeItemsPreview