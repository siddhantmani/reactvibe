...
import FlowlistPreview from './FlowlistPreview';
import FlowlistItemsPreviewSourceCode from './FlowlistItemsPreviewSourceCode';

function FlowlistItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <FlowlistItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
        </div>
...
export default FlowlistItemsPreview