...
import FlowlistFAQPreview from './FlowlistFAQPreview';
import FlowlistItemsFAQPreviewSourceCode from './FlowlistItemsFAQPreviewSourceCode';

function FlowlistItemsFAQPreview() {
...
export default FlowlistItemsFAQPreview