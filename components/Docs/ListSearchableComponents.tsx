// /components/docs/ListSearchableComponents.ts
const ListSearchableComponents = [
    // Backgrounds
    { name: "Gradient Halo", path: "/docs/backgrounds/gradient-halo" },
...
export default ListSearchableComponents;
