...
import GlideAccordioPreview from './GlideAccordioPreview';
import GlideAccordionItemsPreviewSourceCode from './GlideAccordionItemsPreviewSourceCode';
...
function GlideAccordionItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <GlideAccordionItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
...
export default GlideAccordionItemsPreview