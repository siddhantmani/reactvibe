...
function TablePorpsForGlideAccordionItems() {
    return (
        <div className="wrap-anywhere text-wrap">
            ...
            <Table className="dark:text-white border dark:border-gray-300 rounded-3xl">
                ...
                <TableBody>
                    ...
                    <TableRow>
                        <TableCell className={PropertyPoint.className}>align</TableCell>
                        <TableCell className={PropertyPoint.className}>left | right </TableCell>
                        <TableCell className={PropertyPoint.className}>
                            The alignment of the glide accordion.
                        </TableCell>
                    </TableRow>
...
export default TablePorpsForGlideAccordionItems
