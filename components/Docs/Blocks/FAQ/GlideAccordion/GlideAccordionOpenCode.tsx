...
function GlideAccordionOpenCode() {
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Blocks/FAQ/Glide-Accordion/Page.tsx" },
            { name: "GlideAccordion.tsx", path: "/Blocks/FAQ/Glide-Accordion/GlideAccordion.tsx" },
        ],
    };
...
export default GlideAccordionOpenCode;
