...
function SplitFAQItemsOpenCode() {
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Blocks/FAQ/Split-FAQ/Page.tsx" },
            { name: "SplitFAQ.tsx", path: "/Blocks/FAQ/Split-FAQ/SplitFAQ.tsx" },
        ],
    };
...
export default SplitFAQItemsOpenCode;
