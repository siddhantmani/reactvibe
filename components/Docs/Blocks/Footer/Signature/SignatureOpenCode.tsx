...
function SignatureOpenCode() {
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Blocks/Footer/Signature/Page.tsx" },
            { name: "Signature.tsx", path: "/Blocks/Footer/Signature/Signature.tsx" },
        ],
    };
...
export default SignatureOpenCode;
