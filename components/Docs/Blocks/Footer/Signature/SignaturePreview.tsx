...
function SignaturePreview() {
    ...
    return (
        <footer
            className="relative overflow-hidden pb-0 flex flex-col justify-between min-h-[80vh] max-w-7xl mx-auto 
        ...
        >
            ...
            <div className="absolute bottom-[-15px] @md:bottom-[-30px] @xl:bottom-[-30px] left-0 w-full text-center z-10 pointer-events-none">
                <LinearReveal
                    as={'h1'}
                    Text="React Vibe"
                    className={`
            ${FooterHeading.className}
            text-[55px] @md:text-[130px] @lg:text-[120px] @xl:text-[150px]
            leading-none
