...
function RadiantFrameCode() {
    const currentYear = new Date().getFullYear()
    const angle = useMotionValue(0)
    const animatedBorder = useTransform(
        angle,
        (a) =>
            `linear-gradient(${a}deg, #000000, #000000, #f5e2ae, #dcd7fc)`
    )
    ...
    return (
        <footer className="relative overflow-hidden pb-0 flex flex-col justify-between px-2">
            ...
            >
                {/* White card */}
                <div className="bg-white dark:bg-[#0C0C0C] rounded-4xl p-6 @md:p-10 @md:py-16 gap-10 transition-colors duration-300">
                    <div className="flex flex-col space-y-10 @md:space-y-0 @md:flex-row @md:justify-between items-start">
                        ...
                        <div className="space-y-6 max-w-md">
                            ...
                            <div className="space-y-3">
                                ...
                                >
                                    <button
                                        className={`${CTAButton.className} w-[100%]  px-0 py-3 bg-white dark:bg-[#0D0E12] text-[#353838] dark:text-white rounded-full text-sm @md:text-[13px] hover:bg-gray-50 dark:hover:bg-[#1A1C23] transition-all`}
                                    >
                                        Use it
                                    </button>
                                </motion.div>
                        ...
                        <div className="flex space-x-12">
                            ...
                            >
                                ...
                                <div>
                                    <h2
                                        className={`${MainHeading.className} text-black dark:text-white text-xl font-medium tracking-wide mb-3 transition-colors`}
                                    >
                                        Legal
                                    </h2>
                                    <ul
                        ...
                        <div className="pt-10 space-y-5 text-gray-700 dark:text-gray-400 transition-colors">
                            ...
                            <div className="flex flex-col-reverse @md:flex-row gap-5 justify-between ">
                                <div className="flex items-center gap-1">
                                    ...
                                    <p>{currentYear} React Vibe, Inc. All rights reserved.</p>
                                </div>
                                <div className="flex items-center gap-2">
                                    <FaXTwitter className="hover:text-black dark:hover:text-white cursor-pointer transition-colors" />
                                    <FaLinkedinIn className="hover:text-black dark:hover:text-white cursor-pointer transition-colors" />
                                    <FaFacebookF className="hover:text-black dark:hover:text-white cursor-pointer transition-colors" />
                                </div>
                            </div>
                        </div>
                    </motion.div>
...
export default RadiantFrameCode