...
function AuraBaseCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Blocks/Footer/AuraBase/Page.tsx" },
            { name: "AuraBase.tsx", path: "/Blocks/Footer/AuraBase/AuraBase.tsx" },
        ],
    };
