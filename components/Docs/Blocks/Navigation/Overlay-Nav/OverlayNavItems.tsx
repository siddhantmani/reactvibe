...
function OverlayNavItems() {
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className='px-2 xl:max-w-5xl lg:max-w-2xl 2xl:max-w-7xl space-y-7 mx-auto'>
            ...
            <div className='space-y-3 pt-4'>
                ...
                <p className="text-black/70 dark:text-white/70 text-[13px]">
                    A Responsive Navbar Component with a built-in Navbar Mobile Menu, clean navigation, and dark mode support for modern React websites.
                </p>
            </div>
