...
import MorphMenuPreview from './MorphMenuPreview';
import MorphMenuPreviewSourceCode from './MorphMenuPreviewSourceCode';
import RelatedBlocks from '@/components/RelatedBlocks';
import { navigationBlocks } from '@/lib/blocks/navigation';

function MorphMenuItemsPreview() {
    ...
    return (
        <div>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="mprph-menu"
                    blocks={navigationBlocks}
                    basePath="/docs/blocks/navigation"
                    title="Explore more Navigation blocks"
                />
            </div>
        </div>
    )
...
export default MorphMenuItemsPreview