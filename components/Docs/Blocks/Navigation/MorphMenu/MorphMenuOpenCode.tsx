...
function MorphMenuOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Blocks/Navigation/MorphMenu/Page.tsx" },
            { name: "MorphMenu.tsx", path: "/Blocks/Navigation/MorphMenu/MorphMenu.tsx" },
        ],
    };
...
export default MorphMenuOpenCode;