...
function MorphNavOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Blocks/Navigation/MorphNav/Page.tsx" },
            { name: "MorphNav.tsx", path: "/Blocks/Navigation/MorphNav/MorphNav.tsx" },
        ],
    };
...
export default MorphNavOpenCode;