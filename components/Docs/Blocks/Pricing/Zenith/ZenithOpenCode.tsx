...
function ZenithOpenCode() {
    
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Blocks/Pricing/Zenith/Page.tsx" },
            { name: "Zenith.tsx", path: "/Blocks/Pricing/Zenith/Zenith.tsx" },
        ],
    };
