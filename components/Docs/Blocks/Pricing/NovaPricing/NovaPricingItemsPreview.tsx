...
import NovaPricingPreview from './NovaPricingPreview';
import NovaPricingItemsPreviewSourceCode from './NovaPricingItemsPreviewSourceCode';
...
function NovaPricingItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    <TabPanel
                        ...
                        className="border border-gray-700 rounded-2xl relative h-[830px] bg-white dark:bg-[#0b0b0b]"
                    >
                    ...
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <NovaPricingItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
...
export default NovaPricingItemsPreview