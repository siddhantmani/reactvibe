...
function AuroraPricingOpenCode() {
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Blocks/Pricing/Aurora-Pricing/Page.tsx" },
            { name: "AuroraPricing.tsx", path: "/Blocks/Pricing/Aurora-Pricing/AuroraPricing.tsx" },
        ],
    };
...
export default AuroraPricingOpenCode;
