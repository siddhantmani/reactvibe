...
import FluxHeroPreview from './FluxHeroPreview';
import FluxHeroPreviewSourceCode from './FluxHeroPreviewSourceCode';
import RelatedBlocks from '@/components/RelatedBlocks';
import { heroBlocks } from '@/lib/blocks/hero';

function FluxHeroItemsPreview() {
    ...
    return (
        <div className='relative'>
            ...
            <div className="max-w-7xl mx-auto pb-24">
                <RelatedBlocks
                    currentSlug="flux-hero"
                    blocks={heroBlocks}
                    basePath="/docs/blocks/hero"
                    title="Explore more Hero blocks"
                />
            </div>
        </div>
    )
...
export default FluxHeroItemsPreview