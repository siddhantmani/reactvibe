import SpotlightGridPreview from '@/components/Docs/Backgrounds/SpotlightGrid/SpotlightGridPreview'
...
function FluxHeroPreview() {
    ...
    return (
        <div className='dark:bg-[#0c0c0c] relative w-full'>
            <div className='z-0'>
                <SpotlightGridPreview spotlightSize={230} />
            </div>
            <div className=''>
                <div className='hidden @md:inline-block z-0 w-full'>
                    <MorphNav />
                </div>
                <div className='@md:hidden z-50 absolute w-full top-0'>
                    <MorphMenu />
                </div>

                <div className="flex flex-col items-center justify-center text-center px-4 2@xl:pt-60 @md:pt-50 pt-40 max-w-5xl mx-auto font-sans transition-colors duration-300">
                ...
                <div className="@2xl:-mt-80 @md:-mt-50 -mt-80 pb-10">
                    <WaveCTA
...
export default FluxHeroPreview