...
import TestimonialsMainSection from './TestimonialsMainSection';
import TestimonialsItemsPreviewSourceCode from './TestimonialsSourceCode/TestimonialsItemsPreviewSourceCode';
...
function TestimonialsItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <TestimonialsItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
...
export default TestimonialsItemsPreview