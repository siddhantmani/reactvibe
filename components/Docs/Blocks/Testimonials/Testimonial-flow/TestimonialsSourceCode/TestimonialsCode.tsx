...
function TestimonialsCode() {
    ...
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Blocks/Testimonials/Testimonial-Flow/Page.tsx" },
            { name: "ReviewItems.tsx", path: "/Blocks/Testimonials/Testimonial-Flow/ReviewItems.tsx" },
            { name: "ReviewItemsOne.tsx", path: "/Blocks/Testimonials/Testimonial-Flow/ReviewItemsOne.tsx" },
            { name: "ReviewItemsTwo.tsx", path: "/Blocks/Testimonials/Testimonial-Flow/ReviewItemsTwo.tsx" },
        ],
    };
        ...
        <div>
            ...
            >
                <div className="flex bg-[#1e1e1e] rounded-lg overflow-hidden border border-[#2d2d2d] shadow-lg">
                    {/* Sidebar */}
                    <div className="w-56 bg-[#252526] border-r border-[#333] text-gray-300 p-2 text-sm">
...
export default TestimonialsCode;
