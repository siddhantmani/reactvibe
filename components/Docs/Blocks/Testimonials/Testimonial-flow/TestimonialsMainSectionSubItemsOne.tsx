...
function TestimonialsMainSectionSubItemsOne() {
        ...
        >
            ...
            >
                ...
                {items.map((item, index) => (
                    <div
                        key={`first-${index}`}
                        className="bg-white dark:bg-[#0c0c0c] p-3 rounded-xl space-y-2 mx-2 transition-all duration-300"
                        style={{
                            boxShadow: `
    ...
    `,
                ...
                {items.map((item, index) => (
                    <div
                        key={`second-${index}`}
                        className="bg-white dark:bg-[#0c0c0c] p-3 rounded-xl mx-2 space-y-2 shadow-md hover:shadow-xl transition-all duration-300"
                        style={{
                            boxShadow: `
      0px 12px 40px rgba(60, 80, 180, 0.08),
      0px 20px 60px rgba(0, 0, 0, 0.05)
...
export default TestimonialsMainSectionSubItemsOne