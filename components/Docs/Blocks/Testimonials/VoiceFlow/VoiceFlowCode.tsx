...
function VoiceFlowCode() {
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Blocks/Testimonials/Voice-Flow/Page.tsx" },
            { name: "VoiceFlow.tsx", path: "/Blocks/Testimonials/Voice-Flow/VoiceFlow.tsx" },
        ],
    };
