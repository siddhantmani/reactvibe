...
function SpotlightOpenCode() {
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Blocks/Testimonials/Spotlight/Page.tsx" },
            { name: "Spotlight.tsx", path: "/Blocks/Testimonials/Spotlight/Spotlight.tsx" },
        ],
    };
...
export default SpotlightOpenCode;
