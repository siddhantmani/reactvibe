...
function LaunchOpenCode() {
    ...
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Blocks/Hero/Launch/Page.tsx" },
            { name: "OverlayNavBar.tsx", path: "/Blocks/Hero/Launch/OverlayNavBar.tsx" },
            { name: "OverlayMenuBar.tsx", path: "/Blocks/Hero/Launch/OverlayMenuBar.tsx" },
            { name: "HeroSection.tsx", path: "/Blocks/Hero/Launch/HeroSection.tsx" },
