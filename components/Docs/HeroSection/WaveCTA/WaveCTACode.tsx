...
function WaveCTACode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Hero-Section/Wave-CTA/Page.tsx" },
            { name: "WaveCTA.tsx", path: "/Hero-Section/Wave-CTA/WaveCTA.tsx" },
        ],
    };
