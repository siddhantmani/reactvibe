...
import WaveCTAPreview from './WaveCTAPreview';
import WaveCTAItemsPreviewSourceCode from './WaveCTAItemsPreviewSourceCode';

function WaveCTAItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <div className="flex justify-center items-center dark:text-white text-black z-40 w-full rounded-2xl h-full"
                            >
                                <WaveCTAPreview />
                            </div>
                        </div>
...
export default WaveCTAItemsPreview