        ...
        <div className='mx-2 md:px-5 lg:px-8 xl:px-10 xl:max-w-6xl lg:max-w-3xl space-y-7'>
            ...
            <div className='space-y-3'>
                ...
                <motion.p
                    ...
                    A React animated navbar built with Framer Motion, featuring an overlay navigation menu with smooth transitions and interactive behavior.
                    Designed for modern landing pages, this responsive navigation bar enhances user experience while providing a clean and flexible structure for React applications.
                </motion.p>
            </div>
