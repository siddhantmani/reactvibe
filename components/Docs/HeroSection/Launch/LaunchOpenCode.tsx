...
function LaunchOpenCode() {
    ...
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Hero-Section/Launch/Page.tsx" },
            { name: "OverlayNavBar.tsx", path: "/Hero-Section/Launch/OverlayNavBar.tsx" },
            { name: "OverlayMenuBar.tsx", path: "/Hero-Section/Launch/OverlayMenuBar.tsx" },
            { name: "HeroSection.tsx", path: "/Hero-Section/Launch/HeroSection.tsx" },
