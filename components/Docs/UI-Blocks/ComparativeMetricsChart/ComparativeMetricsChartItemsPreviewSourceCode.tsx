...
import ComparativeMetricsChartOpenCode from "./ComparativeMetricsChartOpenCode"
...
function ComparativeMetricsChartItemsPreviewSourceCode() {
    return (
        <div>
            ...
            >
                <ComparativeMetricsChartOpenCode />
            </motion.div>
...
export default ComparativeMetricsChartItemsPreviewSourceCode