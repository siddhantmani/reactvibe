...
import TransactionTablePreviewOpenCode from "./TransactionTablePreviewOpenCode"
...
function TransactionTablePreviewSourceCode() {
    return (
        <div>
            ...
            >
                <TransactionTablePreviewOpenCode />
            </motion.div>
...
export default TransactionTablePreviewSourceCode