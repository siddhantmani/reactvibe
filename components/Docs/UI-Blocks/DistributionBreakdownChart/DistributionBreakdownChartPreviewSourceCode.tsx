...
import DistributionBreakdownChartOpenCode from "./DistributionBreakdownChartOpenCode"
...
function DistributionBreakdownChartPreviewSourceCode() {
    return (
        <div>
            ...
            >
                <DistributionBreakdownChartOpenCode />
            </motion.div>
...
export default DistributionBreakdownChartPreviewSourceCode