...
import InsightRecommendationCardOpenCode from "./InsightRecommendationCardOpenCode"
...
function InsightRecommendationCardPreviewSourceCode() {
    return (
        <div>
            ...
            >
                <InsightRecommendationCardOpenCode />
            </motion.div>
...
export default InsightRecommendationCardPreviewSourceCode