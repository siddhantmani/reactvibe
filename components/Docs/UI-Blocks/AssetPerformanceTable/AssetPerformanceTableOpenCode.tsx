...
function AssetPerformanceTableOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "page.tsx", path: "/UI-Blocks/AssetPerformanceTable/page.tsx" },
            { name: "DashboardFrame.tsx", path: "/DashboardFrame.tsx" },
            { name: "AssetPerformanceTable.tsx", path: "/UI-Blocks/AssetPerformanceTable/AssetPerformanceTable.tsx" },
...
export default AssetPerformanceTableOpenCode;