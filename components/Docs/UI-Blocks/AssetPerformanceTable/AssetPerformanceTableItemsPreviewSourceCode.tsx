...
import AssetPerformanceTableOpenCode from "./AssetPerformanceTableOpenCode"
...
function AssetPerformanceTableItemsPreviewSourceCode() {
    return (
        <div>
...
export default AssetPerformanceTableItemsPreviewSourceCode