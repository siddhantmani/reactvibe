...
import ActivityTimelineListOpenCode from "./ActivityTimelineListOpenCode"
...
function ActivityTimelineListPreviewSourceCode() {
  return (
      <div>
...
export default ActivityTimelineListPreviewSourceCode