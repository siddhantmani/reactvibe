...
import ActivityTimelineListItemsPreview from './ActivityTimelineListItemsPreview';
...
function ActivityTimelineListItems() {
    return (
        <div className='px-2 md:px-5 lg:px-8 xl:px-10 xl:max-w-6xl lg:max-w-3xl 2xl:max-w-7xl mx-auto space-y-7'>
            ...
            <div className='border-black rounded-2xl'>
                <ActivityTimelineListItemsPreview />
            </div>
        </div>
    )
}

export default ActivityTimelineListItems