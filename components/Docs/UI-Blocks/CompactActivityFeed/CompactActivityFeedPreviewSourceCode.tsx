...
import CompactActivityFeedOpenCode from "./CompactActivityFeedOpenCode"
...
function CompactActivityFeedPreviewSourceCode() {
    return (
        <div>
...
export default CompactActivityFeedPreviewSourceCode