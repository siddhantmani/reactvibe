...
import AlertNotificationListOpenCode from "./AlertNotificationListOpenCode"
...
function AlertNotificationListPreviewSourceCode() {
    return (
        <div>
...
export default AlertNotificationListPreviewSourceCode