...
import AlertNotificationListItemsPreview from './AlertNotificationListItemsPreview';
...
function AlertNotificationListItems() {
    return (
        <div className='px-2 md:px-5 lg:px-8 xl:px-10 xl:max-w-5xl lg:max-w-2xl 2xl:max-w-7xl mx-auto space-y-7'>
            ...
            <div className='border-black rounded-2xl'>
                <AlertNotificationListItemsPreview />
            </div>
        </div>
    )
}

export default AlertNotificationListItems