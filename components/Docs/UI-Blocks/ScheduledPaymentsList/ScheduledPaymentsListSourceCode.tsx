...
import ScheduledPaymentsListOpenCode from "./ScheduledPaymentsListOpenCode"
...
function ScheduledPaymentsListSourceCode() {
    return (
        <div>
...
export default ScheduledPaymentsListSourceCode