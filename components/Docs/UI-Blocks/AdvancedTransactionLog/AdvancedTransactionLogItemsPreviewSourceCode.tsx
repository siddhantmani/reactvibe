...
import AdvancedTransactionLogOpenCode from "./AdvancedTransactionLogOpenCode"
...
function AdvancedTransactionLogItemsPreviewSourceCode() {
    return (
        <div>
            ...
            >
                <AdvancedTransactionLogOpenCode />
            </motion.div>
...
export default AdvancedTransactionLogItemsPreviewSourceCode