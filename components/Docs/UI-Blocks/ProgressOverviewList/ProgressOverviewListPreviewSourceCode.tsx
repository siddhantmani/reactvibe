...
import ProgressOverviewListOpenCode from "./ProgressOverviewListOpenCode"
...
function ProgressOverviewListPreviewSourceCode() {
    return (
        <div>
...
export default ProgressOverviewListPreviewSourceCode