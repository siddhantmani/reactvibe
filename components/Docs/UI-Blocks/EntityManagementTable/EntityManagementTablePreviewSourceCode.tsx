...
import EntityManagementTableOpenCode from "./EntityManagementTableOpenCode"
...
function EntityManagementTablePreviewSourceCode() {
    return (
        <div>
...
export default EntityManagementTablePreviewSourceCode