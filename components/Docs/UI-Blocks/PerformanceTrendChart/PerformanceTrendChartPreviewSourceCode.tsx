...
import PerformanceTrendChartOpenCode from "./PerformanceTrendChartOpenCode"
...
function PerformanceTrendChartPreviewSourceCode() {
    return (
        <div>
...
export default PerformanceTrendChartPreviewSourceCode