...
import StructuredDataTableOpenCode from "./StructuredDataTableOpenCode"
...
function StructuredDataTableItemsPreviewSourceCode() {
    return (
        <div>
...
export default StructuredDataTableItemsPreviewSourceCode