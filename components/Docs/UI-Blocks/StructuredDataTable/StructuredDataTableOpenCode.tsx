...
function StructuredDataTableOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "page.tsx", path: "/UI-Blocks/StructuredDataTable/page.tsx" },
            { name: "DashboardFrame.tsx", path: "/DashboardFrame.tsx" },
            { name: "StructuredDataTable.tsx", path: "/UI-Blocks/StructuredDataTable/StructuredDataTable.tsx" },
...
export default StructuredDataTableOpenCode;