...
import ProgressTrackingListOpenCode from "./ProgressTrackingListOpenCode"
...
function ProgressTrackingListPreviewSourceCode() {
    return (
        <div>
...
export default ProgressTrackingListPreviewSourceCode