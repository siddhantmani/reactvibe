...
function BudgetsOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "DashboardFrame.tsx", path: "/DashboardFrame.tsx" },
            { name: "page.tsx", path: "/Dashboard-Systems/Budgets/page.tsx" },
            { name: "Budgets.tsx", path: "/Dashboard-Systems/Budgets/Budgets.tsx" },
            { name: "BudgetsHeader.tsx", path: "/Dashboard-Systems/Budgets/BudgetsHeader.tsx" },
            { name: "BudgetsMetricsGrid.tsx", path: "/Dashboard-Systems/Budgets/BudgetsMetricsGrid.tsx" },
            { name: "BudgetOverview.tsx", path: "/Dashboard-Systems/Budgets/BudgetOverview.tsx" },
            { name: "BudgetvsActual.tsx", path: "/Dashboard-Systems/Budgets/BudgetvsActual.tsx" },
            { name: "BudgetCategoriesTable.tsx", path: "/Dashboard-Systems/Budgets/BudgetCategoriesTable.tsx" },
            { name: "UpcomingBudgetAlerts.tsx", path: "/Dashboard-Systems/Budgets/UpcomingBudgetAlerts.tsx" },
            { name: "BudgetRecommendationCard.tsx", path: "/Dashboard-Systems/Budgets/BudgetRecommendationCard.tsx" },           
        ],
    };
...
export default BudgetsOpenCode;