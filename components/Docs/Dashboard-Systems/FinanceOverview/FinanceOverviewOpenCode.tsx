...
function FinanceOverviewOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            ...
            { name: "FinancialInsightsGrid.tsx", path: "/Dashboard-Systems/FinanceOverview/FinancialInsightsGrid.tsx" },
            { name: "BudgetProgressList.tsx", path: "/Dashboard-Systems/FinanceOverview/BudgetProgressList.tsx" },
            { name: "CashflowOverviewChart.tsx", path: "/Dashboard-Systems/FinanceOverview/CashflowOverviewChart.tsx" },
            { name: "ExpenseBreakdownChart.tsx", path: "/Dashboard-Systems/FinanceOverview/ExpenseBreakdownChart.tsx" },

            { name: "FinancialActivityGrid.tsx", path: "/Dashboard-Systems/FinanceOverview/FinancialActivityGrid.tsx" },
            { name: "UpcomingBillsList.tsx", path: "/Dashboard-Systems/FinanceOverview/UpcomingBillsList.tsx" },
            { name: "RecentTransactionsTable.tsx", path: "/Dashboard-Systems/FinanceOverview/RecentTransactionsTable.tsx" },
            { name: "FinancialGoalsProgress.tsx", path: "/Dashboard-Systems/FinanceOverview/FinancialGoalsProgress.tsx" },

            { name: "FinanceOverviewFooter.tsx", path: "/Dashboard-Systems/FinanceOverview/FinanceOverviewFooter.tsx" },
        ],
    };
...
export default FinanceOverviewOpenCode;