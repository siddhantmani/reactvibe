...
function ReportsOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "DashboardFrame.tsx", path: "/DashboardFrame.tsx" },
            { name: "page.tsx", path: "/Dashboard-Systems/Reports/page.tsx" },
            { name: "Reports.tsx", path: "/Dashboard-Systems/Reports/Reports.tsx" },
            { name: "ReportsHeader.tsx", path: "/Dashboard-Systems/Reports/ReportsHeader.tsx" },
            { name: "ReportsExportHeader.tsx", path: "/Dashboard-Systems/Reports/ReportsExportHeader.tsx" },
            { name: "ExecutiveSummaryMetrics.tsx", path: "/Dashboard-Systems/Reports/ExecutiveSummaryMetrics.tsx" },
            { name: "ReportsSpendingBreakdown.tsx", path: "/Dashboard-Systems/Reports/ReportsSpendingBreakdown.tsx" },
            { name: "ReportsCashFlowTrend.tsx", path: "/Dashboard-Systems/Reports/ReportsCashFlowTrend.tsx" },
            { name: "SpendingBreakdownCards.tsx", path: "/Dashboard-Systems/Reports/SpendingBreakdownCards.tsx" },
            { name: "ExecutiveSummaryCards.tsx", path: "/Dashboard-Systems/Reports/ExecutiveSummaryCards.tsx" },
...
export default ReportsOpenCode;