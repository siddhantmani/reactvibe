...
function InvestmentsOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "DashboardFrame.tsx", path: "/DashboardFrame.tsx" },
            { name: "page.tsx", path: "/Dashboard-Systems/Investments/page.tsx" },
            { name: "Investments.tsx", path: "/Dashboard-Systems/Investments/Investments.tsx" },
            { name: "InvestmentsHeader.tsx", path: "/Dashboard-Systems/Investments/InvestmentsHeader.tsx" },
            { name: "InvestmentsMetricsGrid.tsx", path: "/Dashboard-Systems/Investments/InvestmentsMetricsGrid.tsx" },
            { name: "PortfolioPerformanceChart.tsx", path: "/Dashboard-Systems/Investments/PortfolioPerformanceChart.tsx" },
            { name: "InvestmentsExpenseBreakdown.tsx", path: "/Dashboard-Systems/Investments/InvestmentsExpenseBreakdown.tsx" },
            { name: "InvestmentHoldingsTable.tsx", path: "/Dashboard-Systems/Investments/InvestmentHoldingsTable.tsx" },
            { name: "InvestmentInsightsCard.tsx", path: "/Dashboard-Systems/Investments/InvestmentInsightsCard.tsx" },
            { name: "InvestmentTransactionsList.tsx", path: "/Dashboard-Systems/Investments/InvestmentTransactionsList.tsx" },
            { name: "MarketUpdateCard.tsx", path: "/Dashboard-Systems/Investments/MarketUpdateCard.tsx" },
...
export default InvestmentsOpenCode;