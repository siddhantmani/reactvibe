...
function PortfolioPerformanceChart() {
    ...
    return (
        ...
        <div
            className={`${boldFont.className} relative overflow-hidden rounded-2xl border dark:border-[#222121] border-black/10`}
        >
            ...
            >
                ...
                <div className="relative z-10">
                    ...
                    {/* Header */}
                    <div className="flex items-start justify-between overflow-x-auto hide-scrollbar gap-2">
