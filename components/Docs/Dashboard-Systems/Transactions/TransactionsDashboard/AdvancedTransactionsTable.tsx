...
function AdvancedTransactionsTable() {
    ...
    return (
        <motion.div
            ...
            <Glow
                ...
                className="rounded-2xl p-2 border dark:border-[#222121] border-black/10"
            >
                ...
                {/* table */}
                <div className='2xl:mt-7 mt-12 overflow-x-auto'>
...
export default AdvancedTransactionsTable