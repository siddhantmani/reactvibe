...
function TransactionsOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "DashboardFrame.tsx", path: "/DashboardFrame.tsx" },
            { name: "page.tsx", path: "/Dashboard-Systems/Transactions/page.tsx" },
            { name: "TransactionsDashboard.tsx", path: "/Dashboard-Systems/Transactions/TransactionsDashboard.tsx" },
            { name: "TransactionsHeader.tsx", path: "/Dashboard-Systems/Transactions/TransactionsHeader.tsx" },
            { name: "TransactionsMetricsGrid.tsx", path: "/Dashboard-Systems/Transactions/TransactionsMetricsGrid.tsx" },
            { name: "AdvancedTransactionsTable.tsx", path: "/Dashboard-Systems/Transactions/AdvancedTransactionsTable.tsx" },
            { name: "ExpenseBreakdownChart.tsx", path: "/Dashboard-Systems/Transactions/ExpenseBreakdownChart.tsx" },
            { name: "RecentTransactionActivity.tsx", path: "/Dashboard-Systems/Transactions/RecentTransactionActivity.tsx" },
            { name: "TransactionSmartInsights.tsx", path: "/Dashboard-Systems/Transactions/TransactionSmartInsights.tsx" },
        ],
    };
...
export default TransactionsOpenCode;