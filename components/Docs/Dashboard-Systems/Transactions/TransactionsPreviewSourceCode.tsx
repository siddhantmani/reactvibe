...
import TransactionsOpenCode from "./TransactionsOpenCode"
...
function TransactionsPreviewSourceCode() {
    return (
        <div>
...
export default TransactionsPreviewSourceCode