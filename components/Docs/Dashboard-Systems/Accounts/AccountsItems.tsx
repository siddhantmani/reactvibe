...
import AccountsItemsPreview from './AccountsItemsPreview';
        ...
        <motion.div
            ...
            <div className='space-y-3'>
                ...
                <p className="text-black/70 dark:text-white/70 text-[13px]">
                    A React Account Dashboard for managing balances, linked accounts, transactions, financial health, and account activity.
                </p>

            </div>

            <div className='border-black rounded-2xl'>
                <AccountsItemsPreview />
            </div>
        </motion.div>
    )
}
