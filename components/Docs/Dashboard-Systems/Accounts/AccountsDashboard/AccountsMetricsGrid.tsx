    ...
    return (
        <div className="grid grid-cols-4 gap-2">
            ...
            <motion.div
                ...
                className="relative aspect-video flex-1 rounded-[15px] bg-gradient-to-br from-[#006b46] via-[#00754d] to-[#00573a] p-3 px-3 shadow-[0_20px_60px_rgba(0,100,60,0.25)]">
            ...
            <motion.div
                ...
                className="flex-1 bg-white rounded-[15px] border border-black/10 p-3 px-3 shadow-[0_10px_30px_rgba(0,0,0,0.03)] aspect-video">
...
export default AccountsMetricsGrid;