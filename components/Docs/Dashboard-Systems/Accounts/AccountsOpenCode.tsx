...
function AccountsOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "DashboardFrame.tsx", path: "/DashboardFrame.tsx" },
            { name: "page.tsx", path: "/Dashboard-Systems/Accounts/page.tsx" },
            { name: "AccountsDashboard.tsx", path: "/Dashboard-Systems/Accounts/AccountsDashboard.tsx" },
            { name: "AccountsHeader.tsx", path: "/Dashboard-Systems/Accounts/AccountsHeader.tsx" },
            { name: "AccountsMetricsGrid.tsx", path: "/Dashboard-Systems/Accounts/AccountsMetricsGrid.tsx" },

            { name: "AccountsManagementTable.tsx", path: "/Dashboard-Systems/Accounts/AccountsManagementTable.tsx" },
            { name: "AccountHealthOverview.tsx", path: "/Dashboard-Systems/Accounts/AccountHealthOverview.tsx" },
            { name: "RecentAccountActivity.tsx", path: "/Dashboard-Systems/Accounts/RecentAccountActivity.tsx" },
            { name: "InstitutionConnectionCTA.tsx", path: "/Dashboard-Systems/Accounts/InstitutionConnectionCTA.tsx" },
...
export default AccountsOpenCode;