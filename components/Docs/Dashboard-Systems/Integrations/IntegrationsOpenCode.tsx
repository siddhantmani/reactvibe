...
function IntegrationsOpenCode() {
    // Folder & File Tree
    const fileTree = {
        Components: [
            { name: "DashboardFrame.tsx", path: "/DashboardFrame.tsx" },
            { name: "page.tsx", path: "/Dashboard-Systems/Integrations/page.tsx" },
            { name: "Integrations.tsx", path: "/Dashboard-Systems/Integrations/Integrations.tsx" },
            { name: "IntegrationsHeader.tsx", path: "/Dashboard-Systems/Integrations/IntegrationsHeader.tsx" },
            { name: "IntegrationsMetricsGrid.tsx", path: "/Dashboard-Systems/Integrations/IntegrationsMetricsGrid.tsx" },
            { name: "PerformanceOverviewChart.tsx", path: "/Dashboard-Systems/Integrations/PerformanceOverviewChart.tsx" },
            { name: "IntegrationActivityFeed.tsx", path: "/Dashboard-Systems/Integrations/IntegrationActivityFeed.tsx" },
...
export default IntegrationsOpenCode;