...
import StratusPreview from './StratusPreview';
import StratusItemsPreviewSourceCode from './StratusItemsPreviewSourceCode';

function StratusItemsPreview() {
...
export default StratusItemsPreview