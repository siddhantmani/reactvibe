    ...
    return (
        <div className="space-y-6 p-2">
            <div className="flex items-center justify-between gap-0 overflow-hidden">
                {/* Left peek card */}
                <div className="flex-shrink-0 max-w-[60%] -ml-[40%] xl:max-w-[35%] xl:-ml-[10%] lg:-ml-[35%] lg:max-w-[60%] md:max-w-[60%] md:-ml-[40%] p-6 rounded-2xl border border-white/10 opacity-30 blur-[3px] scale-[80%] pointer-events-none"
                    style={{
                ...
                {/* Center main card */}
                <div
                    className="scale-[110%] md:scale-[90%] xl:max-w-[110%] lg:w-[90%] p-4 py-4 md:p-8 md:py-10 rounded-2xl border border-white/20 w-[100%]"
                    style={{
                        background: `radial-gradient(circle at 50% 40%, rgba(255,255,255,0.08), rgba(0,0,0,0.95) 70%)`
                    }}
                >
                ...
                {/* Right peek card */}
                <div
                    className="flex-shrink-0 max-w-[60%] -mr-[40%] xl:max-w-[35%] p-6 xl:-mr-[10%] lg:-mr-[35%] lg:max-w-[60%] md:max-w-[60%] md:-mr-[40%]  rounded-2xl border border-white/10 opacity-30 blur-[3px] scale-80 pointer-events-none scale-[90%]"
                    style={{
                        background: `radial-gradient(circle at 50% 40%, rgba(255,255,255,0.08), rgba(0,0,0,0.95) 70%)`
                    }}
                >
