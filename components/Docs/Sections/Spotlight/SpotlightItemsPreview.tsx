...
import SpotlightItemsPreviewSourceCode from './SpotlightItemsPreviewSourceCode';
import SpotlightPreview from './SpotlightPreview';

function SpotlightItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        <div
                            ref={mountRef}
                            className="w-full rounded-2xl py-10 bg-gradient-to-t from-[#141313] to-[#141313]"
                        >
                            <div className="text-white z-40 w-full rounded-2xl h-full scale-[100%]">
                                <SpotlightPreview />
                            </div>
                        </div>
                    </TabPanel>
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <SpotlightItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
        </div>
...
export default SpotlightItemsPreview