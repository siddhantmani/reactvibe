...
import AuraBasePreview from './AuraBasePreview';
import AuraBaseItemsPreviewSourceCode from './AuraBaseItemsPreviewSourceCode';

function AuraBaseItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        <div
                            ref={mountRef}
                            className="w-full rounded-2xl pt-10 bg-white"
                        >
                    ...
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <AuraBaseItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
            </TabGroup>
        </div>
...
export default AuraBaseItemsPreview