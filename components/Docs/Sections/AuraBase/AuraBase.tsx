...
function AuraBase() {
    ...
    return (
        <footer className="relative overflow-hidden pb-0 flex flex-col justify-between px-2 min-h-[77vh]">
            {/* Animated card container */}
            <motion.div
                style={{ background: animatedBorder }}
                className="bg-white rounded-4xl p-[10px] xl:mx-12 md:mb-32 mb-32"
            >
                <div className="bg-white p-[28px] rounded-4xl">
                    <div className="full mx-auto z-20 flex flex-col xl:flex-row space-y-10 xl:justify-between">
                        {/* White card */}
                        <div className=" ">
            ...
            <div className="absolute bottom-[-15px] md:bottom-[-30px] xl:bottom-[-45px] left-0 w-full text-center z-10">
                <h1
                    className={`
