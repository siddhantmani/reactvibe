...
import LinearRevealPreview from './LinearRevealPreview';
import RefrashContent from '../../RefrashContent';
import LinearRevealItemsPreviewSourceCode from './LinearRevealItemsPreviewSourceCode';

import { motion } from "framer-motion"

function LinearRevealItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    ...
                    >
                        ...
                        >
                            <div
                                className="flex justify-center items-center dark:text-white text-black z-40 w-full rounded-2xl h-full"
                            >
                                <LinearRevealPreview />
                            </div>
                        </div>
                    ...
                    <TabPanel static hidden={selectedIndex !== 1}>
                        <LinearRevealItemsPreviewSourceCode />
                    </TabPanel>
                </TabPanels>
...
export default LinearRevealItemsPreview