...
import DarkFusionBestSettingOneProps from './DarkFusionBestSettingOneProps'

function DarkFusionBestSettingOne() {
    return (
        <div className=''>
            <DarkFusionBestSettingOneProps
                // Scene
...
export default DarkFusionBestSettingOne