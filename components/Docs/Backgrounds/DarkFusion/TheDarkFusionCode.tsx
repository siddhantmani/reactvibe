...
function TheDarkFusionCode() {
    ...
    const fileTree = {
        Components: [
            ...
            { name: "DarkFusion.tsx", path: "/Backgrounds/Dark-Fusion/DarkFusion.tsx" },
        ],
    };
        ...
        <div>
            ...
            >
                <div className="flex bg-[#1e1e1e] rounded-lg overflow-hidden border border-[#2d2d2d] shadow-lg">
                    {/* Sidebar */}
                    <div className="max-w-md bg-[#252526] border-r border-[#333] text-gray-300 p-2 text-sm">
...
export default TheDarkFusionCode;
