...
import RisingLinesItemsPreview from './RisingLinesItemsPreview';
import TablePorpsForRisingLinesItems from './TablePorpsForRisingLinesItems';

function RisingLinesItems() {
    return (
        <motion.div
        ...
        >
            ...
            <div className='border-black rounded-2xl'>
                <RisingLinesItemsPreview />
            </div>

            <div>
                <TablePorpsForRisingLinesItems />
            </div>
        </motion.div>
    )
}

export default RisingLinesItems