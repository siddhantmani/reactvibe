...
function RisingLinesOpenCode() {
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Backgrounds/RisingLines/Page.tsx" },
            { name: "RisingLines.tsx", path: "/Backgrounds/RisingLines/RisingLines.tsx" },
        ],
    };
...
export default RisingLinesOpenCode