...
import RisingLinesPreview from './RisingLinesPreview';
import RisingLinesPreviewSourceCode from './RisingLinesPreviewSourceCode';

function RisingLinesItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    <TabPanel
                        ...
                        className="border border-gray-700 rounded-2xl relative h-[720px] bg-white dark:bg-[#0b0b0b]"
                    >
...
export default RisingLinesItemsPreview