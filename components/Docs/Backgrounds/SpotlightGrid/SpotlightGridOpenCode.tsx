...
function SpotlightGridOpenCode() {
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Backgrounds/SpotlightGrid/Page.tsx" },
            { name: "SpotlightGrid.tsx", path: "/Backgrounds/SpotlightGrid/SpotlightGrid.tsx" },
        ],
    };
    ...
    return (
        <div className="space-y-3">
            <LinearReveal
                as={"h2"}
                className={`${LinearRevealFont.className} text-4xl font-[700]`}
                Text='Steps'
            />
...
export default SpotlightGridOpenCode;
