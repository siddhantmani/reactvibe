...
function TheGradientHaloCode() {
    // 👇 Folder & File Tree
    const fileTree = {
        Components: [
            { name: "Page.tsx", path: "/Backgrounds/Gradient-Halo/Page.tsx" },
            { name: "GradientHalo.tsx", path: "/Backgrounds/Gradient-Halo/GradientHalo.tsx" },
        ],
    };
...
export default TheGradientHaloCode;
