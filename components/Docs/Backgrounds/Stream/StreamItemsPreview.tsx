...
import StreamPreviewSourceCode from './StreamPreviewSourceCode';

function StreamItemsPreview() {
            ...
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex}>
                ...
                <TabPanels className="mt-2">
                    <TabPanel
                        ...
                        className="border border-gray-700 rounded-2xl relative h-[900px] bg-white dark:bg-[#0b0b0b]"
                    >
...
export default StreamItemsPreview