    ...
    const stats = [
        {
            ...
            description:
                "React components, UI blocks, backgrounds, motion, text, and more across 7 categories.",
        },
        {
            icon: (
                <svg
            ...
            description:
                "Complete finance, accounts, transactions, budgets, investments, reports, and integrations.",
        },
        {
            icon: (
                <svg
            ...
            description:
                "Interactive motion patterns built for expressive and polished React interfaces.",
        },
        {
            icon: (
                <svg
            ...
            description:
                "Copy, customize, and ship every component with full control over the code.",
        },
    ]
