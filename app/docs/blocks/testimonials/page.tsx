        ...
        <div className="space-y-10 max-w-7xl mx-auto px-2">
            ...
            >
                ...
                <p className="text-muted-foreground">
                    Production-ready React testimonial sections for customer reviews, social proof, landing pages, product pages, and customer stories, with layouts such as cards, carousels, and animated flows.
                </p>
            </motion.div>

            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                {testimonialsBlocks.map((block, index) => {
                    ...
                    return (
                        ...
                        >
                            <Link
                                href={`/docs/blocks/testimonials/${block.slug}`}
