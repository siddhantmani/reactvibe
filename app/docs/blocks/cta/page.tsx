...
import { ctaBlocks } from "@/lib/blocks/cta";
        ...
        <div className="space-y-10 max-w-7xl mx-auto px-2">
            ...
            >
                ...
                <p className="text-muted-foreground">
                    A collection of ready-to-use React CTA sections for SaaS landing pages, free-trial conversions, and product websites, giving developers complete call-to-action blocks instead of building them from scratch.
                </p>
            </motion.div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                {ctaBlocks.map((block, index) => {
                    ...
                    return (
                        ...
                        >
                            <Link
                                href={`/docs/blocks/cta/${block.slug}`}
