        ...
        <div className="space-y-10 max-w-7xl mx-auto px-2">
            ...
            >
                ...
                <p className="text-muted-foreground">
                    A collection of ready-to-use Navigation Menu Components with responsive navbar layouts, mobile menus, and flexible navigation patterns for modern React websites.
                </p>
            </motion.div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                ...
                {navigationBlocks.map((block, index) => {
                    ...
                    return (
                        ...
                        >
                            <Link
                                href={`/docs/blocks/navigation/${block.slug}`}
