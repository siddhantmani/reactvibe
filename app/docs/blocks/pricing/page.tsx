        ...
        <div className="space-y-10 max-w-7xl mx-auto px-2">
            ...
            >
                ...
                <p className="text-muted-foreground">
                    Production-ready React pricing sections for SaaS and subscription products, with flexible pricing layouts and dark-mode-ready pricing tables.
                </p>
            </motion.div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                ...
                {pricingBlocks.map((block, index) => {
                    ...
                    return (
                        ...
                        >
                            <Link
                                href={`/docs/blocks/pricing/${block.slug}`}
