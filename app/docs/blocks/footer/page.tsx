    ...
    <div className="space-y-10 max-w-7xl mx-auto px-2">
      ...
      >
        ...
        <p className="text-muted-foreground">
          Production-ready React footer components for landing pages, with social links, newsletter sections, and responsive layouts.
        </p>
      </motion.div>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
        {footerBlocks.map((block, index) => {
          ...
          return (
            ...
            >
              <Link
                href={`/docs/blocks/footer/${block.slug}`}
