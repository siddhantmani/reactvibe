        ...
        <div className="space-y-10 max-w-7xl mx-auto px-2">
            ...
            >
                ...
                <p className="text-muted-foreground">
                    Production-ready React FAQ sections and accordion layouts for SaaS, product, and landing pages, with responsive designs and built-in dark mode for easy copy-paste integration.
                </p>
            </motion.div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                {faqBlocks.map((block, index) => {
                    ...
                    return (
                        ...
                        >
                            <Link
                                href={`/docs/blocks/faq/${block.slug}`}
