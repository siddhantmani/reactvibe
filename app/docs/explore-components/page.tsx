...
import { componentBlocks } from "@/lib/componentsData";
    ...
    return (
        <div className="space-y-10 max-w-7xl mx-auto px-2">
            ...
            >
                ...
                >
                    Browse production-ready React components, dashboard systems,
                    UI blocks, hero sections, and interactive animations built for
