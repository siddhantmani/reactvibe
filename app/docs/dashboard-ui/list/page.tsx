        ...
        <div className="space-y-10 max-w-7xl mx-auto px-2">
            ...
            >
                ...
                <p className="text-muted-foreground">
                    A growing collection of reusable React list components for SaaS dashboards, admin panels, activity feeds, notifications, payments, and data-driven interfaces.
                </p>
            </motion.div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                {listBlocks.map((block, index) => {
                    ...
                    return (
                        ...
                        >
                            <Link
                                href={`/docs/dashboard-ui/list/${block.slug}`}
