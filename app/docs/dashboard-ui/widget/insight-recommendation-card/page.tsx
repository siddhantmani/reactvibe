...
import InsightRecommendationCardItems from '@/components/Docs/Dashboard-UI/Widget/InsightRecommendationCard/InsightRecommendationCardItems'
...
function InsightRecommendationCard() {
    return (
        <div>
            <RenderOnRoute path="/docs/dashboard-ui/widget/insight-recommendation-card" withTransition>
