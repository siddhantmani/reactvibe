        ...
        <div className="space-y-10 max-w-7xl mx-auto px-2">
            ...
            >
                ...
                <p className="text-muted-foreground">
                    A collection of reusable React dashboard widgets and cards for surfacing business insights, metrics, recommendations, and key data in modern dashboards.
                </p>
            </motion.div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                {widgetBlocks.map((block, index) => {
                    ...
                    return (
                        ...
                        >
                            <Link
                                href={`/docs/dashboard-ui/widget/${block.slug}`}
