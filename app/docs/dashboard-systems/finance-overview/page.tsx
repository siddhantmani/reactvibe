...
export const metadata: Metadata = {
    ...
    description:
        "Build a responsive React Finance Dashboard featuring Budget Dashboard Templates, Expense Tracking Dashboards, Cash Flow Dashboards, and financial analytics.",
}
