...
function Page() {
    ...
    return (
        ...
        <div className="xl:mt-[100px] mt-[50px] flex flex-col gap-5 md:flex-row md:px-[20px] lg:px-[2px] md:items-center max-w-4xl mx-auto dark:bg-[#0c0c0c]">
            <div className='flex flex-col justify-center items-center md:justify-start md:items-start space-y-3'>
                ...
                >
                    <OrbitBorder
                        ...
                        RingColors={["#0c0c0c", "#ffffff", "#ffffff", "#0c0c0c"]}
                        style={{
                            boxShadow: `
                ...
                <div className='flex flex-col items-center justify-center md:items-start md:justify-start gap-2 '>
                    ...
                    >
                        <h1 className={`${FeaturesTagline.className} text-black dark:text-white xl:text-5xl xl:max-w-xl md:max-w-[500px] md:text-[26px] lg:text-[29px] max-w-[400px] text-4xl text-center md:text-start min-[320px]:text-[31px] min-[375px]:text-[36px] min-[425px]:text-[39px]`}>Got Questions? We’ve Got Answers</h1>
                    </motion.div>
                    ...
                    >
                        <p className={`${FeaturesBTN.className} text-black/70 dark:text-white/70 md:text-[16px] xl:text-lg text-center md:text-start md:max-w-[400px] text-lg max-w-[400px] min-[320px]:text-[15px] min-[375px]:text-[18px] min-[425px]:text-[20px] px-2`}>Everything you need to know, explained clearly and simply.</p>
                    </motion.div>

                </div>
            </div>

            <div className='border-[0px] border-[#131925] p-4 rounded-[10px] bg-[#fbfbfb] dark:bg-[#0c0c0c] max-w-sm mx-auto'>
                <SplitFAQ
                    items={faqItems}
