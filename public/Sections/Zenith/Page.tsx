...
function Page() {
    return (
        <div className='bg-gradient-to-t from-[#141313] to-[#141313] h-screen py-10'>
            <motion.div
                ...
                <div className=' max-w-36 mx-auto'>
                    ...
                    >
                        ...
                        >
                            ...
                            <h1 className={`${labelName.className} text-[14px] text-white whitespace-nowrap`}>Pricinng</h1>
                        </div>
                    </OrbitBorder>
                </div>
