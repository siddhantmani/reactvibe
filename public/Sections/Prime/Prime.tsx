...
function Prime() {
    ...
    return (
        ...
        <div className='flex flex-col lg:flex lg:flex-row justify-center xl:px-32 lg:px-5 md:px-3 space-y-10'>
            <div className='lg:max-w-[35%] flex flex-col md:flex-row md:items-center lg:flex-col lg:items-start xl:flex-col xl:items-start justify-between px-3 space-y-16 md:space-y-0'>
                <div className='space-y-2'>
                    ...
                    >
                        <h1 className={`${heading.className} text-[#454B57] xl:text-6xl lg:text-5xl md:text-5xl text-5xl md:max-w-[70%] lg:max-w-[100%] xl:max-w-[100%]`}>Simple pricing. Real value.</h1>
                    </motion.div>
                    <MonthlyYearly yearly={yearly} setYearly={setYearly} />
                </div>

                <Link href="https://x.com/_siddhantmani" target='_blank' className='hidden lg:inline-block'>

                    <motion.div className=' relative flex items-center lg:w-[130%] gap-3 bg-white p-2 rounded-2xl cursor-pointer'
                        whileHover="hover"
                    >
                        <motion.div
            ...
            <Link href="https://x.com/_siddhantmani" target='_blank' className='lg:hidden px-4 sm:max-w-[70%] md:max-w-[60%]'>
