...
function Page() {
    return (
        <div className='overflow-hidden relative z-50 h-screen'>
            ...
            <div className='-mt-83 '>
                <div>
                    ...
                    >
                        ...
                        {/* Static curved lines */}
                        <motion.path
                            d={"M 40 120 Q 120 200 250 200 L 550 200 Q 680 200 760 120"}
                            stroke="#000000"
                            strokeOpacity="0.50"
                            strokeWidth="0.50"
                            fill="none"
                ...
                <div className='pt-20 md:pt-25 xl:pt-28 2xl:pt-35'>
                    <svg
                        viewBox="0 0 800 400"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div className='pt-20 md:pt-25 xl:pt-28 2xl:pt-34'>
                    <svg
                        viewBox="0 0 800 400"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
            ...
            <div className='pt-30 md:pt-44 xl:pt-51 2xl:pt-75'>
                <div>
                    <svg
                        viewBox="0 0 800 400"
                        fill="none"
