...
export default function NotificationScreenIphoneDuo() {
    ...
    return (
        <div className='min-h-screen bg-slate-100 dark:bg-[#070809] flex flex-col justify-center items-center p-6 md:p-12 overflow-x-hidden'>
