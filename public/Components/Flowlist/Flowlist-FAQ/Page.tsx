            ...
            <div className='flex flex-col justify-center items-center md:justify-start md:items-start gap-2'>
                ...
                >
                    <OrbitBorder
                        ...
                        padding={2}
                        rounded={120}
                        className='bg-[#ffffff] rounded-[120px] p-2 text-black px-3 text-[11px]'
                ...
                <div className='flex flex-col items-center justify-center md:items-start md:justify-start px-0 gap-2 '>
                    ...
                    >
                        <h1 className={`${FeaturesTagline.className} text-black xl:text-5xl xl:max-w-xl md:max-w-[500px] md:text-3xl lg:text-5xl max-w-[400px] text-4xl text-center md:text-start min-[320px]:text-[33px] min-[375px]:text-[36px] min-[425px]:text-[39px] px-2`}>Got Questions? We’ve Got Answers</h1>
                    </motion.div>
                    ...
                    >
                        <p className={`${FeaturesBTN.className} text-black/70  xl:text-lg text-center md:text-start md:max-w-[400px] text-lg max-w-[400px] min-[320px]:text-[15px] min-[375px]:text-[18px] min-[425px]:text-[20px] px-2`}>Everything you need to know, explained clearly and simply.</p>
                    </motion.div>
