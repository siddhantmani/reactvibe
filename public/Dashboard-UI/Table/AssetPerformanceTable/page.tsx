...
function Page() {
    ...
    return (
        ...
        <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className={`${boldFont.className} max-w-7xl mx-auto mt-20 relative overflow-hidden rounded-[18px] border border-black/[0.06] bg-white dark:border-white/10 dark:bg-[#0c0c0c] dark:shadow-none p-2 shadow-[0_1px_2px_rgba(0,0,0,0.03),0_12px_40px_rgba(0,0,0,0.04)]`}
        >
