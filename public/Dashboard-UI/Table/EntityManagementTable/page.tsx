...
function Page() {
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="rounded-[15px] border border-black/10 dark:border-white/10 bg-white dark:bg-[#0c0c0c] p-2 px-2 aspect-video max-w-7xl mx-auto mt-20">
            ...
            {/* Table */}
            {/* FIX 1: Changed `overflow-hidden` to `overflow-x-auto` to allow scrolling */}
            <div className="mt-8 overflow-x-auto rounded-2xl border border-black/5 dark:border-white/10">

                {/* FIX 2: Wrapped the table contents in a min-width container */}
