...
function Page() {
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="relative overflow-hidden rounded-[28px] border border-[#DDEEDD] dark:border-white/10 bg-[#ffffff] dark:bg-[#0c0c0c] p-3 px-3 aspect-auto max-w-lg mx-auto mt-20">
